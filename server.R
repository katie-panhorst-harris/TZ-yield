...
#setwd("FILEPATH") #fill in path to app folder here
...
#read in the data
yieldsraw <- read.dta("data/shiny.dta") #we have a .dta file from Stata, but this could be any type of data file that R or Foreign can read
